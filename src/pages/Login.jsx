            ...
            <div className='flex gap-20'>
                ...
                <div className='font-inter border px-16 py-14 rounded-lg'>
                    ...
                    <form onSubmit={handleLogin}>
                        ...
                        <div className='mt-5'>
                            <button type="button" className="flex w-[461px] h-14 items-center justify-center w-full px-6 py-5 mx-2 text-sm font-medium text-white transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:bg-blue-400 focus:outline-none">
